...
Ct0718Dlg::Ct0718Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_T0718_DIALOG, pParent)
{
...
void Ct0718Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR Ct0718Dlg::OnQueryDragIcon()
{
